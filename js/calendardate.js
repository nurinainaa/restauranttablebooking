...
---------------------------------------------------------------------*/
        ...
        // Add event listener to each date element for date selection
       document.querySelectorAll('.calendar-dates li').forEach(function(dateElement) {
    dateElement.addEventListener('click', function() {
        ...
        // Add the 'active' class to the selected date element
